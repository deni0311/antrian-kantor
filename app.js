...
app.get('/tv', (req, res) => {
    ...
    <body style="margin:0; padding:0; font-family:sans-serif; background:#f4f7f9; height:100vh; display:flex; flex-direction:column; overflow:hidden;">
        <div style="background:#2c5e9e; color:white; padding:15px 40px; display:flex; justify-content:space-between; align-items:center; border-bottom:6px solid #d4af37;">
            <div><h1 style="margin:0; font-size:50px;">PT ASABRI (PERSERO)</h1><small>CABANG MALANG</small></div>
        ...
        <script>
            const s = io();
            function up() { const d = new Date(); document.getElementById('jam').innerText = d.toLocaleTimeString('id-ID'); }
...
// 2. HALAMAN AMBIL NOMOR (DIPERBARUI DENGAN JAM & RUNNING TEXT)
    ...
    <body style="margin:0; padding:0; font-family:sans-serif; background:#f4f7f9; height:100vh; display:flex; flex-direction:column; overflow:hidden;">
        ...
        <div style="flex:1; display:flex; justify-content:center; align-items:center; padding:20px;">
            <div style="background:white; border:3px solid #d4af37; padding:80px; border-radius:40px; text-align:center; box-shadow:0 15px 30px rgba(0,0,0,0.1); cursor:pointer;" onclick="s.emit('tambah-antrian')">
                ...
                <p style="color:#666; margin-top:15px;">Silakan ambil struk setelah dicetak</p>
            </div>
        </div>
        ...
        <div id="p" style="display:none; font-family:monospace; width:42mm; text-align:center;">
            ...
            <p>Nomor Antrian:</p>
            <h1 id="n" style="font-size:60pt; margin:10px 0;">0</h1>
            <p id="t"></p><hr>
            <p id="sisa_print" style="font-weight:bold;"></p>
        ...
        <script>
            ...
            s.on('siap-cetak', (d) => {
                ...
                document.getElementById('sisa_print').innerText = "Sisa Antrian: " + (d.total - d.dipanggil);
